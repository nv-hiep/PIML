...
def train_model(model, train_loader, val_loader, lr=0.001, device='cuda', num_epochs=100, beta_schedule='constant', beta_max=1.):
    ...
    for epoch in range(num_epochs):
        ...
        if val_loss < best_val_loss:
            ...
            torch.save(model.state_dict(), 'best_vae_model_a00_smooth_mod4_mw_400_500.pt')
...
plt.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('best_vae_model_a00_smooth_mod4_mw_400_500.png', dpi=300, bbox_inches='tight')
plt.show()
...
if False:
    saved_model_path = 'best_vae_model_a00_smooth_mod4_mw_400_500.pt'
